          ...
          SmallSection(
            ...
            children: [
                ...
                children: [
                  Flexible(
                    child: AppIntegerFormField(
                      labelText: _appLocalizations.healthStatusCreationSystolic,
                      suffixText: "mmHg",
                      validator: formValidators.numRangeValidator(0, 350),
                      initialValue: _initialHealthStatus?.systolicBloodPressure,
                      onSaved: (value) {
              ...
              Padding(
                ...
                child: Text(
                    _appLocalizations.healthStatusCreationBloodPressureHelper),
              ),
            ],
          ),
          SmallSection(
            ...
            children: [
              AppSelectFormField<WellFeelingEnum>(
                ...
                items: [
                  ...
                  AppSelectFormFieldItem(
                    text: _appLocalizations.healthStatusCreationWellFeelingGood,
                    icon: Icons.sentiment_satisfied,
                  ...
                  AppSelectFormFieldItem(
                    text: _appLocalizations.healthStatusCreationWellFeelingBad,
                    icon: Icons.sentiment_very_dissatisfied,
              ...
              AppSelectFormField<AppetiteEnum>(
                ...
                items: [
                  AppSelectFormFieldItem(
                    text: _appLocalizations.healthStatusCreationAppetitePerfect,
                    icon: Icons.sentiment_very_satisfied,
                  ...
                  AppSelectFormFieldItem(
                    text: _appLocalizations.healthStatusCreationAppetiteAverage,
                    icon: Icons.sentiment_dissatisfied,
                  ...
                  AppSelectFormFieldItem(
                    text: _appLocalizations.healthStatusCreationAppetiteVeryBad,
                    icon: Icons.sick,
